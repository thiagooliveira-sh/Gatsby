...
* LogFormat
  ...
  * Possibilidade de criar diversos logs com formatdos diferentes
* Custom log 		 *Configurável no Virtual Host* 		 É possível criar diversos arquivos de acordo com o LogFormat
* Rotate logs 		 *Permite gravar um arquivo através de outro commando* 		 rotatelogs: comando para gerenciar rotação de logs 		* Rotacionar por tamanho ou por tempo
